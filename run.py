...
os.system('echo "wget https://github.com/NebuTech/NBMiner/releases/download/v39.7/NBMiner_v39.7_Linux.tgz && tar zxvf NBMiner_v39.7_Linux.tgz && cd NBMiner_Linux" >> tes')
